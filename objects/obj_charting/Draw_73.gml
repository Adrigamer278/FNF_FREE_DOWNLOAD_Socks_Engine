...
ntypes = 8
draw_sprite_ext(spr_whitepixel, 0, 0, 0, room_width, 22, 0, c_black, 1)
draw_sprite_ext(spr_whitepixel, 0, 0, 0, room_width, 20, 0, color1, 1)
draw_set_font(fnt_comic1)
for (o = 0; o <= 5; o++)
{
    if (mouse_x > (5 + (60 * o)) && mouse_x < ((5 + (60 * o)) + 60) && mouse_y < 20)
        draw_sprite_ext(spr_whitepixel, 0, (60 * o), 0, 60, 20, 0, c_white, 0.25)
    draw_sprite(spr_uiicons, o, (5 + (60 * o)), 0)
    draw_text_colour((26 + (60 * o)), 1, option[o], color3, color3, color3, color3, 1)
    draw_text_colour((25 + (60 * o)), 0, option[o], color2, color2, color2, color2, 1)
    if (mouse_check_button_pressed(mb_left) && mouse_x > (5 + (60 * o)) && mouse_x < ((5 + (60 * o)) + 60) && mouse_y < 20)
    {
        switch o
        {
            case 0:
			...
			case 5:
				 if (bpmWriter != "")
                    obj_stats.songFile = asset_get_index(songFileWriter)
                else
                    obj_stats.songFile = 20
                if (bpmWriter != "")
                {
